...
The Zyxel XGS4728F switch does have one major flaw, it does not support 100mbit speed optics to come up, which our 1625nm optics are. luckily it does give the correct Tx and Rx values for these optics.

This network only intended to test our dBm comparison script with usable dBm values and is therefore not intended to be 'plug-and-play' like the Primary test network.
